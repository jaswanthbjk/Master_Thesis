...
%     \end{itemize}
% \end{frame}
\begin{frame}{Proposed $OD^2$ benchmark}
    \begin{table}[H]
        \centering
...
\begin{frame}{Sample Images}
    \begin{columns}[t]
        ...
        \captionof{figure}{BDD100K (In-Distribution)}
        \column{.3\textwidth}
        ...
        \captionof{figure}{Indian Driving Dataset (OOD)}
        \column{.3\textwidth}
        ...
        \captionof{figure}{Climate-GAN images (OOD)}
    \end{columns}
\end{frame}
...
\begin{frame}{SSD Performance}
    \begin{table}[]
        \centering
        \caption{AP values of SSD300 model with different prior boxes}
        \label{tab:my-table}
        \resizebox{\textwidth}{!}{%
        \begin{tabular}{llllllllll}
        \hline
        \multirow{2}{*}{Prior boxes} & \multicolumn{9}{l}{\textbf{Agents}}                                   \\ \cline{2-10} 
         &
          \textbf{Pedestrian} &
          \textbf{Rider} &
          \textbf{Car} &
          ...
          \textbf{Bicycle} &
          \textbf{Traffic Sign} &
          \multicolumn{1}{c}{\textbf{Mean}} \\ \hline
        \textbf{vanilla}             & 0.006 & 0.004 & 0.095 & 0.083 & 0.15  & 0.045 & 0.092 & 0.001 & 0.059 \\ \hline
        \textbf{tuned}               & 0.165 & 0.135 & 0.479 & 0.389 & 0.389 & 0.163 & 0.213 & 0.186 & 0.267 \\ \hline
        \end{tabular}%
        }
        \end{table}
    \begin{columns}
        \column{0.45\linewidth}
        \includegraphics[width=\columnwidth,height=3cm]{images/det_images/bdd_1.jpg}
        \captionof{figure}{sample detection from BDD100K dataset}
        \column{0.45\linewidth}
        \includegraphics[width=\columnwidth,height=3cm]{images/det_images/idd_2.jpg}
        \captionof{figure}{sample detection from IDD dataset}
    \end{columns}
\end{frame}
...
\begin{frame}[allowframebreaks]{UQ models - Performance}
    ...
    \begin{table}[]
        \centering
        \caption{AP values of various SSD300 models}
        \label{tab:my-table}
        \resizebox{\textwidth}{!}{%
        \begin{tabular}{llllllllll}
        \hline
        \multirow{2}{*}{\textbf{Models}}     & \multicolumn{9}{l}{\textbf{Agents}}                                                       \\ \cline{2-10} 
         &
          \textbf{Pedestrian} &
          \textbf{Rider} &
          \textbf{Car} &
          ...
          \textbf{Traffic Sign} &
          \multicolumn{1}{c}{\textbf{Mean}} \\ \hline
        \textbf{SSD300}             & 0.165 & 0.135 & 0.479 & 0.389 & 0.389 & 0.163 & 0.213 & 0.186 & 0.267                     \\ \hline
        \textbf{Bayesian SSD300}    & 0.172 & 0.149 & 0.476 & 0.4   & 0.401 & 0.196 & 0.232 & 0.184 & 0.276                     \\ \hline
        \textbf{SubEnsemble SSD300} & 0.167 & 0.144 & 0.47  & 0.393 & 0.396 & 0.181 & 0.211 & 0.171 & \multicolumn{1}{c}{0.267} \\ \hline
        \end{tabular}%
        }
    \end{table}
    ...
    \begin{columns}
        ...
        \captionof{figure}{UQ on image from BDD100K dataset}
        \column{0.45\linewidth}
        \includegraphics[width=\columnwidth,height=3cm]{images/det_images/idd_subens_variances_0.png}
        \captionof{figure}{UQ on image from IDD dataset}
    \end{columns}
...
\begin{frame}[allowframebreaks]{UQ models - OOD Detection}
    ...
    \begin{table}[tbp]
        ...
        \caption{AUROC scores for classifying BDD100K and IDD datasets using UQ metrics}
        \resizebox{\textwidth}{!}{%
        ...
        \multirow{3}{*}{Bayesian-SSD300} &
         ...
         &
          ...
          - &
          0.64 \\ \hline
        \multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}SubEnsemble\\ SSD300\end{tabular}} &
          Probability &
          0.44 &
          0.21 &
          0.34 &
...
\begin{columns}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{llll}
            \hline
                      &               & \begin{tabular}[c]{@{}l@{}}Bayesian\\ SSD300\end{tabular} & \begin{tabular}[c]{@{}l@{}}SubEnsemble\\ SSD300\end{tabular} \\ \hline
    ...
    \column{0.45\linewidth}
        \begin{itemize}
            \item performance has deteriorated especially in the case of flood images.
            \item uncertainty quantification methods performed almost similar
            to an unbiased random classifier.
            \item Results complies with the results reported by \citep{Ovadia2019}
        \end{itemize}
\end{columns}
\end{frame}
