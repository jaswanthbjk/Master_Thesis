...
\begin{frame}{SSD Performance}
    \begin{itemize}
        \begin{columns}
            ...
            \item SSD model with vanilla prior boxes
                \begin{table}
                    \caption{AP values for various classes using vanilla Prior boxes}
                    \begin{tabular}{ll}
                        \hline
                ...
                \end{table}
            \column{0.5\linewidth}
            \item SSD model with tuned prior boxes
            \begin{table}
...
\begin{columns}
    ...
    \column{0.45\linewidth}
        \begin{itemize}
            ...
            \item Results complies with the results reported by \citet{Ovadia2019}
        \end{itemize}
\end{columns}
\end{frame}
